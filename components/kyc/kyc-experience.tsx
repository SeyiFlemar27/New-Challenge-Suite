...
export function kycStatusCopy(statusValue?: string | null, required = false): StatusCopy {
  ...
  const copies: Record<string, StatusCopy> = {
    ...
    verified: { label: "Verified", title: "Identity verified", body: "Your identity has been verified. Premium-sensitive tools may now unlock where all other plan, provider, and admin requirements are met.", cta: "Return to Dashboard", href: "/dashboard", secondary: "View Wallet", secondaryHref: "/wallet", tone: "success" },
