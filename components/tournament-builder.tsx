...
import { SPONSOR_CATEGORY_OPTIONS, TOURNAMENT_BRACKET_SIZES, normalizeSponsorCategories } from "@/lib/forms/canonical-options";
...
export function TournamentBuilder() {
  ...
  function draftPayload(status: "draft" | "pending_review" = "draft") {
    return {
      ...
      sponsorship: { sponsorReady: form.sponsorReady, acceptSponsorshipProposals: form.acceptSponsorshipProposals, sponsorCategories: normalizeSponsorCategories(form.sponsorCategories), sponsorPlacementPreferences: form.sponsorPlacementPreferences, confirmedSponsorFundingMinor: 0 }
    };
  }
