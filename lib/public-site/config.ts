...
faqs:[["How do I join a challenge?","Open a public challenge, review its requirements and use the available join action. Some challenges require approval or a confirmed entry payment."],["Are all challenges paid?","No. Creators can publish free or paid-entry challenges, and each challenge displays its entry requirements before you continue."],["When can I submit?","Every challenge shows its official submission window. Final submissions are accepted only while that window is open."],["How does voting work?","Voting is available only during the configured window and only for eligible submissions. Owners cannot vote on their own challenge."],["How are winners selected?","Winner rules are set on each challenge. Results can use eligible voting, judging and review before winners are confirmed."],["How are prizes funded?","Prize sources and confirmed funding are tracked separately from unconfirmed proposals or promises."],["When do winners receive payment?","Approved internal prize credits remain subject to wallet availability, identity checks and platform review before withdrawal."],["Can brands sponsor a challenge?","Eligible sponsor accounts can discover opportunities, submit proposals and fund approved arrangements through the protected sponsor workflow."],["Can I create private challenges?","Eligible creator and host plans can create restricted challenges with invitation or approval controls."],["Where can I get help?","Use the support and report actions available across Challenge Suite. Include the relevant challenge or transaction reference when possible."]]
};
