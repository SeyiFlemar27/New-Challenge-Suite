...
export const ENTERPRISE_PERMISSIONS = [
  "challenge.create_official", "challenge.create_personal", "challenge.view", "challenge.edit", "challenge.assign",
...
const ROLE_PERMISSIONS: Record<EnterpriseRole, EnterprisePermission[]> = {
  ...
  operations: ["challenge.create_official", "challenge.create_personal", "challenge.view", "challenge.edit", "challenge.assign", "participants.view", "participants.manage", "submissions.view", "submissions.review", "reviews.view", "results.view", "results.propose", "finance.view", "sponsors.view", "team.view", "team.manage", "notes.view", "notes.write", "activity.view", "analytics.view", "boost.redeem"],
...
export type EnterpriseAccessRecord = {
  status: "active" | "suspended" | "revoked" | "pending_onboarding";
  role: EnterpriseRole;
...
export function normalizeEnterpriseAccess(source: Record<string, unknown>): EnterpriseAccessRecord | null {
  ...
  if (!approved || !isEnterpriseRole(roleValue)) return null;
