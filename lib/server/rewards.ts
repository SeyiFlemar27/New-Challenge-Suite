...
export const DEFAULT_REWARD_PRIZES: RewardPrize[] = [
  prize("default-basic-dorocoin", "Small DoroCoin Bonus", "A small internal platform-credit bonus. DoroCoins are not cash.", "basic", "dorocoin_bonus", "automatic", 22, 25), prize("default-basic-vote", "1 Free Vote", "One bonus vote credit for eligible challenges.", "basic", "free_vote", "automatic", 24, 1), prize("default-basic-badge", "Basic Badge", "A profile badge reward foundation.", "basic", "badge", "automatic", 18), prize("default-basic-discount", "Small Discount", "A manually reviewed discount reward.", "basic", "discount", "manual", 16), prize("default-basic-try-again", "Try Again", "No prize this time. Your spin remains recorded.", "basic", "try_again", "automatic", 20),
  prize("default-standard-dorocoin", "Larger DoroCoin Bonus", "A larger internal platform-credit bonus.", "standard", "dorocoin_bonus", "automatic", 22, 75), prize("default-standard-votes", "Multiple Free Votes", "Multiple bonus vote credits for eligible challenges.", "standard", "free_vote", "automatic", 22, 3), prize("default-standard-highlight", "Profile Highlight", "Profile highlight reviewed by the Challenge Suite team.", "standard", "profile_highlight", "manual", 18), prize("default-standard-coupon", "Sponsor Coupon", "Sponsor coupon fulfillment requires admin or sponsor review.", "standard", "sponsor_coupon", "manual", 18), prize("default-standard-entry", "Challenge Entry Discount", "Entry discount foundation. No cash-out value.", "standard", "discount", "manual", 20),
  prize("default-premium-dorocoin", "Bigger DoroCoin Bonus", "Premium internal platform-credit bonus. No DoroCoin-to-cash conversion.", "premium", "dorocoin_bonus", "automatic", 20, 150), prize("default-premium-badge", "Premium Badge", "Premium profile badge foundation.", "premium", "badge", "automatic", 20), prize("default-premium-ticket", "Event Ticket", "Manual event-ticket fulfillment.", "premium", "event_ticket", "manual", 15), prize("default-premium-merch", "Merch/Product Prize", "Manual physical or partner prize fulfillment.", "premium", "merch", "manual", 20), prize("default-premium-gift", "Gift Card / Manual Prize", "Manual fulfillment only. No cash-out prize is enabled by default.", "premium", "gift_card", "manual", 25)
];
