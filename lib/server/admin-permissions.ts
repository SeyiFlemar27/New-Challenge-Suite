export const ADMIN_PERMISSIONS = [
  ...
  "withdrawals.markPaid", "refunds.request", "refunds.approve", "wallet.adjust", "settlements.prepare",
  ...
  "systemDiagnostics.view", "jobs.retry", "auditLogs.viewRaw", "qaTools.use"
] as const;
...
const rolePermissions: Record<AdminRole, AdminPermission[]> = {
  ...
  finance_admin: ["admin.dashboard.view", "admin.actionCentre.view", "admin.search.use", "users.view", "challenges.view", "finance.view", "finance.export", "withdrawals.review", "withdrawals.approve", "withdrawals.secondApprove", "withdrawals.markPaid", "refunds.request", "refunds.approve", "settlements.prepare", "settlements.approve", "promotionalFunding.create", "promotionalFunding.approve", "sponsorFunds.release", "auditLogs.viewRaw"],
  ...
  technical_admin: ["admin.dashboard.view", "admin.actionCentre.view", "admin.search.use", "settings.view", "settings.editIntegrations", "developerTools.view", "featureControls.manage", "systemDiagnostics.view", "jobs.retry", "auditLogs.viewRaw", "qaTools.use"],
  developer_support: ["admin.dashboard.view", "admin.actionCentre.view", "admin.search.use", "settings.view", "developerTools.view", "systemDiagnostics.view", "auditLogs.viewRaw"]
};
