...
assert(phase.includes("now >= timeline.submissionOpensAt") && phase.includes("now < timeline.submissionClosesAt"), "submission window must include the start instant and exclude the deadline");
