...
assert(sidebar.includes("label: \"My Challenges\"") && sidebar.includes("label: \"Build a Challenge\""), "personal navigation must expose owned challenges and entitlement-aware creation");
