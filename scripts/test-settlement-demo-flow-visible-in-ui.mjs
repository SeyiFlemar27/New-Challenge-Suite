...
assert(financePage.includes("Platform Fee (15%)") && financePage.includes("Sponsor Prize Platform Fee"), "finance UI must show both platform fee categories without hardcoding an obsolete sponsor rate");
