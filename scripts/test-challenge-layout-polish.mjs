...
assert(myChallenges.includes('redirect("/challenges")') && challengesPage.includes("Propose Winners"), "My Challenges should redirect and Challenges should keep winner proposal action.");
