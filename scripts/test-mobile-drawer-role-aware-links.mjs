...
for (const marker of ["guestSections", "adminSections", "creatorSections", "sponsorSections", "Logout", "Sponsor Dashboard", "Admin Dashboard"]) assert(source.includes(marker), marker);
