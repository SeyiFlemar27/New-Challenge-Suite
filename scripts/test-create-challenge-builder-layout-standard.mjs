...
assert(builder.includes("rounded-[8px]") && builder.includes("lg:grid-cols-[260px_minmax(0,1fr)]") && !builder.includes("overflow-x-auto"), "builder layout must use stable vertical app card standards.");
