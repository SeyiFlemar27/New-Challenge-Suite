...
assert(dashboard.includes("hasSponsorReportableData") && reports.includes("sponsorReports"), "sponsor dashboard/reporting foundation must exist");
assert(analytics.includes("not_tracked_yet") || dashboard.includes("No data yet"), "untracked metrics must be marked unavailable rather than faked");
