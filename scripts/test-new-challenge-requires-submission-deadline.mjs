...
if (!builder.includes("registrationDeadline: form.registrationDeadline") || !builder.includes("submissionStartAt: form.startsAt")) throw new Error("Builder must persist separate registration and submission-opening times.");
