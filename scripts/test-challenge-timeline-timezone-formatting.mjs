...
assert(formatter.includes('DEFAULT_CHALLENGE_TIME_ZONE = "Africa/Lagos"'), "WAT fallback must be explicit");
...
assert(formatter.includes('replace(/\\bGMT\\+1\\b|\\bGMT\\+01:00\\b/, "WAT")'), "Africa/Lagos must display WAT");
...
assert.equal(resolveChallengeTimeZone({}), "Africa/Lagos", "missing timezone must use WAT fallback");
