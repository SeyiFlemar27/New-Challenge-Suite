...
const order = ["data-mobile-challenge-meta", "aspect-[16/10]", "data-mobile-creator-row", "data-mobile-primary-action", "Challenge Guide", "Leading Participants", "Comments", "Recommended Challenges"];
let cursor = -1;
