...
assert(detail.includes("submissionChecklistLabel") && detail.includes("Opens ${formatJourneyDate") && detail.includes('return "Closed"'), "detail checklist must distinguish opens/open/closed labels");
