...
assert(prize.includes("Admin approval is required before ledger finalization") && prize.includes("payoutProviderCalled: false"), "ledger finalization must be admin-gated with no payout execution");
