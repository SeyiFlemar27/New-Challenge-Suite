...
assert(viewerState.includes("Registration still open") && viewerState.includes("Waiting for submissions") && joinPage.includes("Join Challenge"), "join page must show enrollment and non-open submission states.");
