...
assert.match(api, /enterprise_application_submitted/);
assert.match(api, /enterprise_application_updated/);
...
assert.match(adminApi, /const batch = db\.batch\(\)/);
assert.match(adminApi, /enterpriseAccessStatus: status/);
assert.match(adminApi, /enterprise_application_approved/);
assert.match(adminApi, /enterprise_application_rejected/);
assert.match(adminApi, /enterprise_application_info_requested/);
