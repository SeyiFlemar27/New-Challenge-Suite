...
assert(api.includes("trendScore") && api.includes("participantCount") && api.includes("voteCount") && api.includes("saveCount"), "trending must use real-data scoring signals");
