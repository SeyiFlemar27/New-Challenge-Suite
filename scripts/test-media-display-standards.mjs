...
assert(challenge.includes("ChallengeMediaGallery"), "Challenge detail must use the controlled media gallery.");
assert(mine.includes('redirect("/challenges")') || mine.includes("ChallengeMediaFrame"), "My Challenges must use the canonical challenge listing or a controlled media frame.");
assert(
  messages.includes('redirect("/messages")') || messages.includes("MessageAttachmentPreview"),
  "Messages must route to or use the controlled attachment preview.",
);
