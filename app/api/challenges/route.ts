...
export async function POST(request: Request) {
  ...
  const challenge = {
    ...
    mediaStorageStatus: body.usesPlaceholderMedia ? "storage_disabled" : [body.coverImagePath, body.promoImagePath, body.trailerVideoPath, body.promoVideoPath, ...body.documentPaths].some(Boolean) ? "uploaded" : "metadata_only",
