    ...
    const events = liveEventRecords
      .map((doc) => {
        ...
        return {
          ...
          eventMode: data.eventMode ?? "physical_first_external_livestream",
          externalLiveUrl: data.externalLiveUrl ?? null,
          externalLiveProvider: data.externalLiveProvider ?? null,
          externalLiveStatus: data.externalLiveStatus ?? "not_ready",
          externalLiveOpensAt: data.externalLiveOpensAt ?? null,
          externalLiveCtaLabel: data.externalLiveCtaLabel ?? "Watch live on partner site",
