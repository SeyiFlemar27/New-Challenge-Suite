    ...
    <AppShell>
      <div className="mx-auto max-w-4xl space-y-6">
        <Card className="p-8 text-center sm:p-10">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><LinkButton href="/dashboard">Go to Dashboard</LinkButton><LinkButton href="/wallet" variant="secondary">View Wallet</LinkButton><LinkButton href="/revenue-share" variant="secondary">View Revenue</LinkButton></div>
        </Card>
      </div>
    </AppShell>
  );
