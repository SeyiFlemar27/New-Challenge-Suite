  ...
  return (
    ...
    >
      ...
      {step === 3 ? <Card className="p-6 sm:p-8"><div className="grid gap-6 sm:grid-cols-2">
        ...
        <Field label="Voting and judging preference"><select className={inputClass} value={form.votingPreference} onChange={(event) => update("votingPreference", event.target.value)}><option value="public">Public voting</option><option value="credits">Challenge Credit additional voting</option><option value="judge">Judge review</option><option value="hybrid">Hybrid voting + judges</option><option value="manual">Manual winner confirmation</option></select></Field>
