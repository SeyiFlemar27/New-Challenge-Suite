...
function sourceLabel(value: string) { if (value === "challenge_winner_prize") return "Challenge winner prize"; if (value === "sponsor_prize") return "Sponsor-funded prize"; if (value === "creator_challenge_earning") return "Creator challenge earning"; if (value === "prediction_reward") return "Prediction reward"; return "Financial activity"; }
