    ...
    <AppShell>
      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-[1fr_360px]">
        <Card className="p-6 sm:p-8">
          ...
          <p className="mt-5 rounded-[8px] border border-yellow-500/20 bg-yellow-500/5 p-4 text-sm leading-6 text-yellow-100">Prediction Arena is coming soon and remains compliance-gated. No settlement, payout, prize release, or winner payment is active.</p>
        </Card>
        <Card className="p-6">
