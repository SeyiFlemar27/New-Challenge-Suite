...
const modules = [
  { title: "Participant Management", body: "Review registration and participant status foundations.", icon: UsersRound, href: "/dashboard/host/participants" },
  { title: "Submission Review", body: "Review pending competition submissions without automatic winner selection.", icon: ShieldCheck, href: "/dashboard/host/submissions" },
  { title: "Voting Control", body: "Monitor voting windows, visibility, and review states.", icon: Vote, href: "/dashboard/host/voting" },
  { title: "Tournament Builder", body: "Build draft brackets and competition structures.", icon: Swords, href: "/tournaments" },
  { title: "Live Event Tools", body: "Manage approved event and registration foundations.", icon: Radio, href: "/live-events" },
  { title: "Reports & Export", body: "Open operational report and export foundations.", icon: Download, href: "/dashboard/host/reports" },
      ...
      <AppShell>
        ...
        <div className="mt-2 flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <LinkButton href="/dashboard/host/submissions" variant="secondary">Review Submissions</LinkButton>
            <LinkButton href="/dashboard/host/voting" variant="secondary">Voting Control</LinkButton>
            <LinkButton href="/dashboard/host/reports" variant="secondary">Reports</LinkButton>
          </div>
        </div>
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          ...
          <Metric title="Pending Participants" value={0} note="Review foundation" />
          <Metric title="Pending Submissions" value={pendingSubmissions} />
          <Metric title="Live Voting Sessions" value={0} note="Monitor foundation" />
          <Metric title="Total Votes" value={totalVotes} />
          <Metric title="Reports Ready" value={0} note="Export foundation" />
        ...
        <Card className="mt-8 p-6 sm:p-8">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2">
            ...
            <Checklist label="Configure voting rules" href="/dashboard/host/voting" />
            ...
            <Checklist label="Review reports" href="/dashboard/host/reports" />
          </div>
        </Card>
