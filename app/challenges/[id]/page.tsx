...
export default function ChallengeDetailPage() {
  ...
  const guideSections: Array<{ id: ChallengeGuideSection; label: string; body: string }> = [
    ...
    { id: "voting", label: "Voting & Judging", body: votingOpen ? "Voting is open for eligible submissions. Free voting and DoroCoin bonus voting remain separate actions." : phase === "voting_pending" ? "Voting becomes available when eligible submissions are approved." : "Voting follows the published challenge schedule and eligibility rules." },
