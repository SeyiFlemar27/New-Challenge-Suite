        ...
        <div className="min-w-0">
          ...
          <Card className="mt-10 p-5 sm:p-7">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <Info title="Prize and earnings" body="Winners are reviewed before earnings become available. Sponsor-funded prizes go 100% to approved winners. KYC, admin review, and the 24-hour hold are required before withdrawal." />
