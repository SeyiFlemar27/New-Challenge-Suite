  ...
  return (
    <AppShell>
      <Card className="mx-auto mt-10 max-w-3xl p-6 sm:p-8 lg:p-10">
        ...
        <h1 className="mt-5 text-3xl font-black">Private Invite Foundation</h1>
        ...
        <p className="mt-5 text-sm leading-6 text-slate-400">Full code regeneration UI remains a foundation state until host moderation tooling is connected. Challenge ID: {params.id}</p>
